 ...
 */
ssize_t cNetComm::sendTo(int sockfd
                         , const void* buf
                         , size_t len
                         , int flags)
{
 ...
 * @return The number of bytes sent, -1 on error
 */
ssize_t cNetComm::recvFrom(int sockfd
                           , void* buf
                           , size_t len
                           , int flags)
{
 ...
 */
int cNetComm::getaddressinfo(const char* node
                             , const char* service
 ...
 */
void cNetComm::freeaddressinfo(struct addrinfo* res)
{
    freeaddrinfo(res);
}
/*!
