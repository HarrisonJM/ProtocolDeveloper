/*!
 * @brief unit tests for the network communication library
...
protected:
    ...
    std::shared_ptr<networkCommunication::NetworkCommunication> nC;
    ...
    void SetUp() override
    {
        ...
        nC = std::make_shared<networkCommunication::NetworkCommunication>(cnetmock);
    }
